...
- `lib/` - non-pure, non-component code (the store, the Prisma singleton, shared types, the player-id hook, the player-name hook, the room-stream hook, the step-cue hook, the reduced-motion hook).
